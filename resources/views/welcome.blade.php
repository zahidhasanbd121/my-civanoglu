<x-guest-layout>
                ...
                <form action="{{route('properties')}}" method="GET" class="flex justify-between">
                    ...
                    <div class="flex w-7/12 justify-between items-center">
                        <div class="flex flex-col mx-3">
                            <select name="sale" class="focus:ring-0 border-double border-4 rounded">
                        ...
                        <div class="flex flex-col mx-3">
                            <select name="type" class="border-0 focus:ring-0 border-double border-4 rounded">
                        ...
                        <div class="py-3 self-center border-gray-500 border"></div>
                        <div class="flex flex-col mx-3">
                            <select name="price" class="border-0 focus:ring-0 border-double border-4 rounded">
                        ...
                        <div class="py-3 self-center border-gray-500 border"></div>
                        <div class="flex flex-col mx-3">
                            <select name="bedrooms"class="border-0 focus:ring-0 border-double border-4 rounded">
                    ...
                    <div class="flex justify-between items-center w-5/12 ml-5">
                        <input type="search" placeholder="Try to search for something" class="border-double border-4 rounded-lg px-4 py-2 w-full mr-4 focus:border-gray-700 focus:ring-0">
    ...
    <div class="py-32 text-center">
        <div class="container">
            <h2 class="font-bold text-4xl mb-6">Lorem ipsum dolor sit amet consectetur <br> adipisicing elit. obcaecati!<span class="underline">nesciunt inventore.</span></h2>
            <p class="text-gray-500 text-2xl font-bold mb-10">Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque repellat hic necessitatibus.</p>

            <a class="border-2 border-gray-700 text-bold rounded-2xl text-2xl px-8 py-3 inline-block" href="">Start The Searching</a>
