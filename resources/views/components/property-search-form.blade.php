    ...
    <div class="flex w-7/12 justify-between items-center">
        ...
        <div class="flex flex-col mx-3">
            ...
            <select id="price" name="price" class="border-0 focus:ring-0">
                ...
                <option {{request('price') == '100000' ? 'selected="selected"' : ''}} value="100000">10000 - 100000</option>
                ...
                <option {{request('price') == '500000' ? 'selected="selected"' : ''}} value="400000">400000 - 500000</option>
